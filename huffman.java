...
public class huffman {
    public static class TreeNode implements Comparable<TreeNode> {
        ...
        TreeNode(String lossy, int freq, TreeNode left, TreeNode right, String bit) {
            this.lossy = lossy;
            this.freq = freq;
            this.left = left;
            this.right = right;
    ...
    public String generatePasswordFromUsername(String username, int minLength, boolean cap, boolean digit,
        ...
        password.append("a");
        if (cap) {
            int v = (int) Math.random() * 25; //The Math.random () function returns a floating-point random number in range 0–1 (inclusive of 0, but not 1)
